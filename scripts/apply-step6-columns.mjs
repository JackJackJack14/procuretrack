/**
 * รัน migration ขั้น 6 บน Supabase Cloud
 * ใช้: SUPABASE_DB_PASSWORD=... node scripts/apply-step6-columns.mjs
 */
...
if (!password) {
  console.error("ต้องระบุ SUPABASE_DB_PASSWORD");
  process.exit(1);
}
    ...
    const verify = await client.query(
      `select column_name from information_schema.columns
       where table_schema = 'public' and table_name = 'projects'
         and column_name = 'appeal_report_approval_date'`,
    );
    console.log("OK: step6 migration applied");
