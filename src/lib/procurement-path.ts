...
export const PROCUREMENT_PATH_OPTIONS: Array<{
...
}> = [
  {
    ...
    description: "ดำเนินครบ 10 ขั้นตอน e-GP ตามลำดับ — ระบบตรวจสอบทุกขั้นตอน",
  },
  {
    value: "external",
    label: "หน่วยงานอื่น (ส่วนกลาง/สพข. เขต) เป็นผู้ดำเนินการจัดซื้อจัดจ้างให้",
    description:
      "สำหรับสัญญาที่ได้รับมาจากส่วนกลาง — ข้ามขั้นตอนที่ 1-7 ไปเริ่มบันทึกสัญญา/งวดงานที่ขั้นตอนที่ 9",
  },
];
