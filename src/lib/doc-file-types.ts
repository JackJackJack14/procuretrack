...
const DOC_TYPE_POLICY: Record<string, DocFilePolicyId> = {
  ...
  [STEP6_DOC.HEAD_APPEAL_DECISION_LETTER]: "pdf_only",
  [STEP6_DOC.CGD_SUBMISSION_REPORT_LETTER]: "pdf_only",
  ...
  [STEP7_DOC.PERFORMANCE_BOND_LETTER]: "pdf_only",
  [STEP7_DOC.CONTRACT_DRAFT_APPROVAL_MEMO]: "pdf_only",
  [STEP7_DOC.PERFORMANCE_BOND_EXEMPTION_MEMO]: "pdf_only",
  [STEP7_DOC.ABANDONMENT_REPORT_MEMO]: "pdf_only",
  ...
  [STEP10_DOC.WARRANTY_BANK_GUARANTEE]: "pdf_only",
  [STEP10_DOC.GUARANTEE_RETURN]: "egp_screenshot",
};
