/** เนื้อหา Guideline Box — ขั้นตอนที่ 5 เปิดซองและสรุปผลการพิจารณา (อินโฟกราฟิก 3 การ์ด) */

export const STEP5_GUIDELINE_ACTION_ITEMS = [
  "• คณะกรรมการร่วมกันดาวน์โหลดและเปิดเผยข้อเสนอจากระบบ e-GP แล้วทำการเปิดซองใบเสนอราคา",
  "• ตรวจสอบคุณสมบัติ ข้อเสนอทางเทคนิค และจัดทำรายงานสรุปผลการพิจารณาเสนอหัวหน้าหน่วยงาน",
